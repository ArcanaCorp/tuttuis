        ...
        <>
            ...
            <section className="w m-auto bg-white p4 rounded-md lg:w mt4 mb4" style={{"--w": "90%", "--w-lg": "60%"}}>
                ...
                <article className="mb6">
                    ...
                    <p className="mb3">ttutis es un sistema digital que permite a las instituciones educativas:</p>
                    <ul className="flex flex-col gap-2 pl4">
                ...
                <Link href={'/legal/terms'}>Términos y condiciones de Uso</Link>
            </section>
